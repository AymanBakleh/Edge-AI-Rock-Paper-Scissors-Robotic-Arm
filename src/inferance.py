        ...
        for hand in event.hands:
            ...
            try:
                ...
                if 'classification' in result['result']:
                   ...
                   detected_gesture = max(classification, key=classification.get)
                   # Send the detected gesture to the Arduino
                   send_gesture_to_arduino(detected_gesture)
...
def main():
    model_file = "/home/ayman/Desktop/data/modelfile.eim" 
